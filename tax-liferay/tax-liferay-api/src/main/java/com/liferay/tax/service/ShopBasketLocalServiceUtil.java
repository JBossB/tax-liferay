...
/**
 * Provides the local service utility for ShopBasket. This utility wraps
 * <code>com.liferay.tax.service.impl.ShopBasketLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ShopBasketLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.tax.service.impl.ShopBasketLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.liferay.tax.model.ShopBasket addShopBasket(
		com.liferay.tax.model.ShopBasket shopBasket) {

		return getService().addShopBasket(shopBasket);
	}
	 ...
	 */
	public static com.liferay.tax.model.ShopBasket createShopBasket(
		long shopBasketId) {

		return getService().createShopBasket(shopBasketId);
	}
	 ...
	 */
	public static com.liferay.tax.model.ShopBasket deleteShopBasket(
			long shopBasketId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteShopBasket(shopBasketId);
	}
	...
	public static com.liferay.tax.model.ShopBasket deleteShopBasket(
		...
		return getService().deleteShopBasket(shopBasket);
	}
	...
	public static com.liferay.tax.model.ShopBasket fetchShopBasket(
		long shopBasketId) {

		return getService().fetchShopBasket(shopBasketId);
	}
	 ...
	 * @throws PortalException if a shop basket with the primary key could not be found
	 */
	public static com.liferay.tax.model.ShopBasket getShopBasket(
			long shopBasketId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getShopBasket(shopBasketId);
	}
	 ...
	 */
	public static java.util.List<com.liferay.tax.model.ShopBasket>
		getShopBaskets(int start, int end) {

		return getService().getShopBaskets(start, end);
	}
	 ...
	 */
	public static int getShopBasketsCount() {
		return getService().getShopBasketsCount();
	}
	 ...
	 */
	public static com.liferay.tax.model.ShopBasket updateShopBasket(
		com.liferay.tax.model.ShopBasket shopBasket) {

		return getService().updateShopBasket(shopBasket);
	}

	public static ShopBasketLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<ShopBasketLocalService, ShopBasketLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ShopBasketLocalService.class);

		ServiceTracker<ShopBasketLocalService, ShopBasketLocalService>
			serviceTracker =
				new ServiceTracker
					<ShopBasketLocalService, ShopBasketLocalService>(
						bundle.getBundleContext(), ShopBasketLocalService.class,
						null);
