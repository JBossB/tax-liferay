...
/**
 * Provides the local service interface for ItemShopBasket. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author jbaeza
 * @see ItemShopBasketLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ItemShopBasketLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.tax.service.impl.ItemShopBasketLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the item shop basket local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ItemShopBasketLocalServiceUtil} if injection and service tracking are not available.
	 */
